  ...
  <v-sheet color="transparent">
    <v-sheet class="relative" height="350px">
      <carousel-3d @after-slide-change="onAfterSlideChange" :perspective="0" :height="320" :border="0" class="mt-0">
        <slide :index="2">
          <div class="d-flex justify-center relative mt-5">
            ...
            <v-card class="rounded-circle d-flex justify-center" :elevation="18" width="220" height="220">
              <div class="d-flex justify-center align-center h-100 relative">
                <div class="text-center">
                  <div class="mb-2">김배민님의 BMTI</div>
                  <h3 class="text-h3 primary-text-color">평화주의</h3>
                </div>
              </div>
            </v-card>
          </v-card>
        ...
        <slide :index="1">
          ...
          <v-card class="rounded-circle d-flex justify-center align-center mx-auto mt-4" width="250" height="250">
            <v-card class="rounded-circle mx-auto" width="220" height="220">
              <div class="d-flex justify-center align-center h-100 relative">
                <div class="text-center">
                  <div class="mb-2"><strong>김배민</strong>님과 함께 할</div>
                  <h3 class="text-h3 primary-text-color">먹메이트</h3>
                </div>
              </div>
            </v-card>
          </v-card>
        ...
        <slide :index="0">
          ...
          <v-card class="rounded-circle d-flex justify-center align-center mx-auto mt-4" width="250" height="250">
            <v-card class="rounded-circle mx-auto" width="220" height="220">
              <div class="d-flex justify-center align-center h-100 relative">
                <div class="text-center">
                  <div class="mb-2"><strong>김배민</strong>님만을 위한</div>
    ...
    <v-sheet class="pl-2 pr-0 relative">
    ...
    <!--    <v-sheet color="white" height="50vh" class="px-6 py-4 relative">-->
    <!--      <h3 class="text-h5 primary-text-color text-center">활동적이고 에너지 넘치는 당신!</h3>-->
    <!--      <p class="text-center font-hanna-air">어떤 상황에서 그 누구와도 잘 어울려요~</p>-->
    ...
    <!--            <v-btn x-large color="primary" depressed class="rounded-xl mx-auto">BMTI 셀프 테스트</v-btn>-->
    <!--          </div>-->
    <!--        </div>-->
    <!--      </div>-->
    <!--    </v-sheet>-->

    <!--    <v-sheet color="white" height="50vh" class="px-6 relative">-->
    <!--      <v-list three-line class="px-0 pt-0">-->
    <!--        <template v-for="(item, index) in items">-->
    <!--          <v-subheader v-if="item.header" :key="item.header" v-text="item.header"></v-subheader>-->
    <!--          <v-divider v-else-if="item.divider" :key="index" :inset="item.inset"></v-divider>-->
    <!--          <v-list-item v-else :key="item.title" class="px-0">-->
    ...
    <!--                {{ item.subtitle }}-->
    <!--                <div class="mt-1">-->
    <!--                  {{ item.creator.nickname }} | {{ item.creator.degree }}-->
...
export default {
  ...
  methods: {
    onAfterSlideChange(index) {
      console.log(index)
      // this.slides[0].title = index !== 0 ? 'BMTI' : '평화주의'
    }
  },
  data() {
    return {
      ...
      items: [
        {
          imagUrl: require('@/assets/elements/food1.png'),
          title: '신상 맛집 뚫으러 갑니다~~!',
        ...
        {
          imagUrl: require('@/assets/elements/food2.png'),
